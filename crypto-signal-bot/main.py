...
async def run_bot():
    ...
    try:
        ...
        await generate_signals()  # İşlenmiş verilerle al-sat sinyalleri oluştur
        print("✅ Sinyal üretimi tamamlandı.")

        print("✉️ Bildirim gönderiliyor...")
        await send_telegram_message("Tüm süreç başarıyla tamamlandı!")  # Sürecin bittiğini bildiren mesaj
...
def main():
    ...
    schedule.every(1).minutes.do(lambda: asyncio.run(run_bot()))  # Her 1 dakikada bir çalıştır
